Proceso Ejercicio2
	...
	Definir total_vendido, promedio, monto_venta, contador Como Real;
	...
	Escribir "Ingrese monto de la venta 1 (o ingrese 0 para terminar): ";
	Leer monto_venta;
	...
	Mientras (monto_venta <> 0) Hacer
		...
		contador <- contador + 1;
		Escribir "Ingrese monto de la venta ", contador," (o ingrese 0 para terminar): ";
		Leer monto_venta;
	...
	Si (cantidad_ventas > 0) Entonces
		...
		Escribir "Promedio por venta: $", trunc(promedio);
	Sino
